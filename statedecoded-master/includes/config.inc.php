 ...
 */
define('SITE_TITLE', 'Los Angeles Decoded');

/*
 * What is the name of the place that these laws govern?
 */
define('PLACE_NAME', 'Los Angeles');

/*
 * What does this place call its laws?
 */
define('LAWS_NAME', 'Los Angeles Municipal Code');
 ...
 */
define('CUSTOM_FUNCTIONS', 'class.LosAngeles.inc.php');
 ...
 */
define('API_KEY', 'ftMqX835ENHzKLi0');
